package com.anymindgroup.btctransactionqueryservice.aop;
...
public class LoggingAspect {
	...
	@Before("execution(* com.anymindgroup.btctransactionqueryservice..*(..)))")
	...
	@After("execution(* com.anymindgroup.btctransactionqueryservice..*(..)))")
